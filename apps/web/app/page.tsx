        ...
        <div className="mx-auto w-full max-w-3xl space-y-14 py-6">
          ...
          <div className="border-border space-y-5 border-y py-4 text-center">
            ...
            <p className="text-muted-foreground">
              The frontend is currently under development. For comprehensive information about this
              port, including setup instructions, technical details, and project structure, please
              refer to the
              <a
