 ...
 * @module WsRequest
 *
 * This module defines schemas and types for WebSocket requests in the beatsync application,
 * utilizing Zod for validation. It encompasses client actions such as play, pause, and spatial audio control.
 */
import { z } from 'zod';
